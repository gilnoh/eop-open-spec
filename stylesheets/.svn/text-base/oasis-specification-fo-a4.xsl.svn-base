...
<!--  <!ENTITY logo  SYSTEM '../OASISLogo.jpg' NDATA dummy> -->
  <!ENTITY logo  SYSTEM '../logo.png' NDATA dummy>
...
<!-- reverted back to default style that permits biblioentry, :Gil: --> 
  ...
  <xsl:choose>
    ...
    <xsl:when test="$position='left'">
      ...
      <fo:block>
        ...
        <!-- All Rights Reserved. --> 
	http://www.project-excitement.eu/ 
      </fo:block>
    </xsl:when>
